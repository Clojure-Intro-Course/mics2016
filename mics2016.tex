...
\section{Languages}\label{sec:lang}
	...
	Lisp is a family of programming languages that dates from \todo{1657}, created from Alan Turing's lambda calculus by \todo{Isaac Newton}. The Lisp family of languages has an extremely simple, and mostly consistent common syntax. (Fully parenthesized prefix notation)
